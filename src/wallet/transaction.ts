...
export class Transaction {
  ...
  async gasPrice(chainIndex: string) {
    ...
    return await this.client.sendRequest<any, (EvmGasPrice | UtxoGasPrice)[]>(
      'GET',
      path,
      {
        chainIndex,
  ...
  async nonce(params: AddressEntry) {
    ...
    return await this.client.sendRequest<AddressEntry, Nonce[]>(
      'GET',
      path,
      params
    )
  ...
  async sui_object(params: SuiObjectEntry, cursor = '1', limit = '50') {
    ...
    return await this.client.sendRequest<any, (SuiObject & CursorItem)[]>(
      'POST',
      path,
      {
        ...params,
  ...
  async send_tx(params: SendTxEntry) {
    ...
    return await this.client.sendRequest<SendTxEntry, { orderId: string }[]>(
      'POST',
      path,
      params
    )
  ...
  async get_send_tx(params: QueryTxsEntry) {
    ...
    return await this.client.sendRequest<QueryTxsEntry, OrderStatus[]>(
      'GET',
      path,
      mergedParams
    )

...
export class AssetByAddress {
  ...
  async utxos(params: AddressIndex, cursor = '1', limit = '50') {
    ...
    return await this.client.sendRequest<any, (Utxos & CursorItem)[]>(
      'GET',
      path,
      {
        ...params,
  ...
  async inscriptions(params: UtxoEntry) {
    ...
    return await this.client.sendRequest<UtxoEntry, Inscriptions[]>(
      'GET',
      path,
      params
    )
  ...
  async approvals(addresses: AddressEntry[], cursor = '1', limit = '50') {
    ...
    return await this.client.sendRequest<any, CursorItem & ApprovalProject[]>(
      'POST',
      path,
      {
        addresses,
